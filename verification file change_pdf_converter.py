...
def main():
    st.markdown(
        ...
        f'<h1>📄 Verification File to PDF Converter</h1>'
        f'<p>Generate Standardized Timetables Directly from the Verification Excel</p>'
        f'</div>'
        f'</div>'
        f'</div>',
        unsafe_allow_html=True
    ...
    with st.sidebar:
        ...
        _sidebar_is_sbm = (
            "School of Business Management" in selected_display
            or "Pravin Dalal" in selected_display
            or "School of Economics" in selected_display
            or "School of Liberal Arts" in selected_display
            or "School of Branding and Advertising" in selected_display
            or "School of Science" in selected_display
            or "School of Commerce" in selected_display
            or "Diploma in Textile Technology" in selected_display
        )
        if _sidebar_is_sbm:
    ...
    with col1:
        st.markdown(
            ...
            '<p style="margin:0; font-size:1rem;">Drag and drop the Verification file exported from the primary app</p>'
            '</div>',
            unsafe_allow_html=True
        )
